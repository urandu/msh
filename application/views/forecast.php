    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
             ...
             <div class="ibox-tools">
              ...
              <input type="text" class="form-control" name="forecast_start_date" value="<?php echo $p->forecast_start_date; ?>">
                </div>

               <div class "form-group">
                <label>Forecast Period: </label>
        
                  <input type="text" class="form-control" name="forecast_period" value="<?php echo $p->forecast_period;?>">
