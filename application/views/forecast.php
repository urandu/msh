    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
             ...
             <div class="ibox-tools">
                ...
                <div class= "form-group"><label>Forecast Start Date:</label><input type="text" required class="form-control" name="forecast_start_date" value="<?php echo $p->forecast_start_date; ?>"></div>
                <div class "form-group"><label>Forecast Period: </label><input type="text" required class="form-control" name="forecast_period" value="<?php echo $p->forecast_period;?>"></div>
               ...
               <div class "form-group">
                <label>Forecast Monthly Consumption: </label>
                  <input type="text" required class="form-control" name="forecast_monthly_consumption" value="<?php echo $p->forecast_monthly_consumption; ?>">
...
?>
 ...
 <div class="modal inmodal" id="save_forecast_commodity_data" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
              ...
              <input type="text" required class="form-control" name="forecast_start_date" placeholder="Forecast start date">
                </div>
               <div class "form-group">
                <label>Forecast Period: </label>        
                  <input type="text" required class="form-control" name="forecast_period" placeholder="Forecast period">
               </div> 
               ...
               <div class "form-group">
                <label>Forecast Monthly Consumption: </label>
                  <input type="text" required class="form-control" name="forecast_monthly_consumption" placeholder="Forecast Mothly Consupmtion">
