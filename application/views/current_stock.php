...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-sm-8">
        <div class="title-action">
            <a href="#" data-toggle="modal" data-target="#central_level_data" class="btn btn-primary">Add current
                stock</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content animated bounceInRight">
                                                    <div class="modal-header">
                                                        ...
                                                        <small class="font-bold">Update and delete details about stocks
                                                    ...
                                                    <form action="<?= base_url(); ?>current_stock/update_central_level"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group"><input type="hidden"
                                                                                           name="central_level_stock_id"
                                                                                           value="<?php echo $central_level_data->central_level_stock_id; ?>"
                                                                                           class="form-control"></div>
                                                            <div class="form-group"><label>Commodity: </label><select
                                                                    class="form-control m-b">
                                                                    <?php foreach ($commodity as $malaria_commodity): ?>
                                                                        <option
                                                                            name="commodity_name" <?php if ($malaria_commodity->commodity_id == $central_level_data->commodity_id) {
                                                                            echo "selected";
                                                                        } ?>><?php echo $malaria_commodity->commodity_name; ?></option>
                                                                    <?php endforeach; ?>
                                                                </select></div>
                                                            <div class="form-group"><label>Funding
                                                                    agency: </label><select
                                                                    class="form-control m-b">
                                                                    <?php foreach ($funding_agency as $agency): ?>
                                                                        <option
                                                                            name="funding_agency_name" <?php if ($agency->funding_agency_id == $central_level_data->funding_agency_id) {
                                                                            echo "selected";
                                                                        } ?>><?php echo $agency->funding_agency_name; ?></option>
                                                                    <?php endforeach; ?>
                                                                </select></div>

                                                            <div class="form-group"><label>Supply chain
                                                                    agency: </label><select class="form-control m-b">
                                                                    <?php foreach ($supply_chain_agency as $supply): ?>
                                                                        <option
                                                                            name="supply_chain_agency" <?php if ($supply->supply_chain_agency_id == $central_level_data->supply_agency_id) {
                                                                            echo "selected";
                                                                        } ?>><?php echo $supply->supply_chain_agency; ?></option>
                                                                    <?php endforeach; ?>
                                                                </select></div>
                                                            <div class="form-group"><label>Opening balance: </label>
                                                                <input
                                                                    type="text" required name="opening_balance"
                                                                    value="<?php echo $central_level_data->opening_balance; ?>"
                                                                    class="form-control"></div>
                                                            <div class="form-group"><label>Supplier receipts: </label>
                                                                <input type="text" required name="total_receipts_from_suppliers"
                                                                       value="<?php echo $central_level_data->total_receipts_from_suppliers; ?>"
                                                                       class="form-control"></div>
                                                            <div class="form-group"><label>Total issues: </label> <input
                                                                    type="text" name="total_issues_to_facilities"
                                                                    value="<?php echo $central_level_data->total_issues_to_facilities; ?>"
                                                                    class="form-control"></div>
                                                            <div class="form-group"><label>Closing balance: </label>
                                                                <input
                                                                    type="text" required name="soh_closing_balance"
                                                                    value="<?php echo $central_level_data->soh_closing_balance; ?>"
                                                                    class="form-control"></div>


                                                            <div class="form-group datepicker-months"><label>Expiry date: </label>
                                                                <input type="text" name="earliest_expiry_date" value="<?php echo $central_level_data->earliest_expiry_date; ?>" class="form-control" pattern="^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$" data-mask="99-99-9999" placeholder="">
                                                                <span class="help-block">dd-mm-yyyy</span>

                                                            <<!--div class="form-group"><label>Expiry date: </label> <input
                                                                    type="text" name="earliest_expiry_date"
                                                                    value="<?php /*echo $central_level_data->earliest_expiry_date; */?>"
                                                                    class="form-control"></div>-->
                                                            <div class="form-group"><label>Quantity expiring: </label>
                                                                <input type="text" name="quantity_expiring"
                                                                       value="<?php echo $central_level_data->quantity_expiring; ?>"
                                                                       class="form-control"></div>

                                                        </div>
                                                        <div class="modal-footer">
                                                            <button id="update" type="submit" class="btn btn-primary">Save changes
                                                            </button>
                                                            <a href="<?php echo(base_url() . "current_stock/delete_central_level_data/" . $central_level_data->central_level_stock_id); ?>"><i
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <form action="<?= base_url(); ?>current_stock/save_central_level" name="Pendingshipment" onsubmit="return validatePendingshipment() method="post"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group"><label>Opening balance: </label> <input type="text" required name="opening_balance"
                    ...
                    <div class="form-group"><label>Supplier receipts: </label> <input type="text" required
                                                                                      name="total_receipts_from_suppliers"
                                                                                      placeholder="Supplier receipts"
                                                                                      class="form-control"></div>
                    <div class="form-group"><label>Total issues: </label> <input type="text" required
                                                                                 name="total_issues_to_facilities"
                                                                                 placeholder="Total issues"
                                                                                 class="form-control"></div>
                    <div class="form-group"><label>Closing balance: </label> <input type="text" required
                ...
                <div class="modal-footer">
                    <button id="submit" type="submit" class="btn btn-primary">Save stock</button>
