                                                ...
                                                <div class="modal-content animated bounceInRight">
                                                    ...
                                                    <form action="<?= base_url();?>commodity/update_commodity" method="post" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group"><label>Funding agency: </label> <input type="text" required name="commodity_name" value="<?php echo $malaria_commodity->commodity_name; ?>" class="form-control"></div>
                                                            <div class="form-group"><label>Unit of measure: </label> <input type="text" required name="unit_of_measure" value="<?php echo $malaria_commodity->unit_of_measure; ?>" class="form-control"></div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button data-id="update" id="update" type="submit" class="btn btn-primary">Save changes</button>
...
<div class="modal inmodal" id="add_commodity" tabindex="-1" role="dialog" aria-hidden="true">
                               <div class="modal-dialog">
                                    <div class="modal-content animated bounceInRight">
                                        ...
                                        <div class="form-group"><label>Commodity: </label> <input type="text" required name="commodity_name" placeholder="Commodity" class="form-control"></div>
                                        <div class="form-group"><label>Unit of measure: </label> <input type="text" required name="unit_of_measure" placeholder="UoM" class="form-control"></div>
                                       <div class="form-group"><label>Description: </label> <input type="text" name="commodity_description" placeholder="Description" class="form-control"></div>
                                        ...
                                        <div class="modal-footer">
                                             <button id="submit" type="submit" class="btn btn-primary">Add commodity</button>
                                             <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
                                           <!--  <input type="submit" id="submit" name="dsubmit" value="Update"> -->
                                        </div>
                                    </form>
