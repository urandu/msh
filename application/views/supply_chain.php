    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8">
             <div class="title-action">
                <div data-toggle="modal" data-target="#save_supply_chain_agency" class="btn btn-primary">Add a new agency</div>
            </div>
        </div>
    </div>
...
<?php foreach ($agencies as $agency): ?>
    ...
    <tr>
        ...
        <div class="modal inmodal" id="myModal_<?php echo $agency->supply_chain_agency_id ?>" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated bounceInRight">
                    ...
                    <div class="modal-body">
                            ...
                            <form action="<?= base_url();?>index.php/supply_chain/update_agency_id1" method="post" enctype="multipart/form-data" autocomplete="on">

                                <div class="form-group">
                                <input type="hidden" name="supply_agency_id" class="form-control" value="<?php echo $agency->supply_chain_agency_id; ?>">
                                </div>

                                <div class="form-group">
                                <label>Agency Name :</label>
                                <input type="text" name="supply_agency_name" class="form-control" value="<?php echo $agency->supply_chain_agency; ?>">
                                </div>
                                ...
                                <input type="text" name="supply_agency_description" class="form-control" value="<?php echo $agency->comment; ?>">
                                </div>
        ...
        <div class="modal inmodal" id="save_supply_chain_agency" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated bounceInRight">
                 ...
                 <form action="<?= base_url();?>index.php/supply_chain/save_supply_chain_agency" method="post" enctype="multipart/form-data" autocomplete="on">
