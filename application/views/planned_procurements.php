    ...
    <div class="row wrapper border-bottom white-bg page-heading" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="col-sm-8">
            <div class="title-action">
                <div data-toggle="modal" data-target="#save_planned_procurements" class="btn btn-primary">Add planned procurement</div>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper wrapper-content">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <form action="<?= base_url();?>index.php/planned_procurements/show_planned_procurements" method="post" enctype="multipart/form-data" autocomplete="on">
                    <div class="form-group"><label class="col-sm-2 control-label">Select Period</label>

                        <div class="col-sm-5"><select class="form-control m-b" name="planned_procurements_period">
                                <option>--SELECT PERIOD--</option>
                                <?php foreach ($ALL_PROCUREMENTS as $planned_procurement):?>
                                    <option name="planned_procurements_period"> <?php echo $planned_procurement->planned_delivery_date;?></option>
                                <?php endforeach; ?>
                            </select></div>
                        <div class="col-sm-5"><button type="submit" class="btn btn-primary">Get planned procurements for selected period</button></div>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped">
                            ...
                            <?php if(isset($planned_procurement_successfully_retrieved)){?>  <!--CHECK IF DATA IS THERE-->
                                ...
                                <?php foreach ($PPROCUREMENTS as $planned_procurements): ?>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content animated bounceInRight">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title">Edit planned procurements</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="<?= base_url();?>index.php/planned_procurements/update_planned_procurement_id" method="post" enctype="multipart/form-data" autocomplete="on">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Period :</label>
                                                                <input type="text" name="period" class="form-control" value="<?php echo $planned_procurements->unit_of_measure; ?>"<div class="form-group">
                                                                </div>

                                                                <div class="form-group">
                                                                    <label>Quantity :</label>
                                                                    <input type="text" name="quantity" class="form-control" value="<?php echo $planned_procurements->quantity; ?>">
                                                                </div>

                                                                <div class="form-group">
                                                                    <label>Expected date of delivery :</label>
                                                                    <input type="text" id="deliverydate" name="expected_date_delivery" class="form-control" value="<?php echo $planned_procurements->planned_delivery_date; ?>">
                                                                </div>

                                                                <div class="form-group">
                                                                    <label>Description :</label>
                                                                    <input type="text" name="pddescription" class="form-control" value="<?php echo $planned_procurements->comment; ?>">
                                                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <i class="fa fa-laptop modal-icon"></i>
                        <h4 class="modal-title">Add planned procurement</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url();?>index.php/planned_procurements/save_planned_procurement" method="post" enctype="multipart/form-data" autocomplete="on">
                            ...
                            <div class="form-group">
                                <label>Period :</label>
                                <input type="text" name="period" class="form-control" placeholder="Period" <div class="form-group">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="deliverydate" name="expected_time_of_arrival" class="form-control" placeholder="Expected time of arrival">
                                </div>
